...
public class AddRelationshipUseCase
{
    ...
    public String execute(AddRelationshipRequest request)
    {
        ...
        final String relationshipId = repository.addRelationship(User.identify(), request.originContactId, request.targetContactId, request.relationshipTypeId, request.notes);
        if (relationshipType.counterpartId != null)
            repository.addRelationship(User.identify(), request.targetContactId, request.originContactId, relationshipType.counterpartId, null);
